...
// spelled with NEBULA_MESSAGE_CONST_SHARED_PTR. A parameter that merely accepts the pointer, such
...
public:
    ...
    const agnocast::SubscriptionOptions & options)
  {
    ...
    static_assert(
      ...
      "NEBULA_MESSAGE_UNIQUE_PTR or NEBULA_MESSAGE_CONST_SHARED_PTR, with "
